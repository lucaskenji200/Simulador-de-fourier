...
from tkinter import messagebox, filedialog # <--- MUDANÇA
import sympy
from sympy import (
...
import traceback
import os
import io                 # <--- MUDANÇA: Para manipulação de bytes na memória
from PIL import Image     # <--- MUDANÇA: Biblioteca para criar o GIF
...
# <--- INÍCIO: FUNÇÃO E BOTÃO ATUALIZADOS PARA SALVAR GIF --- >
...
# ... (todo o resto do seu código, como 'plot_on_canvas', 'calcular_e_plotar', etc., permanece exatamente o mesmo) ...
